...
| `PIN_COMMENT_RETENTION_DAYS` | _(unlimited)_ | When set, comments older than this many days are deleted on server startup and every 6 hours. Unset = unlimited retention. |
